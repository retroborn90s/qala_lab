            ...
            <div className="socials" >
                <div className="container" >
                    <div className="socials-container" >
                        <div className="socials__text" >Подпишитесь, где удобно, чтобы всегда быть в курсе событий
                        </div>
                        <div className="socials-right" >
                            <div className="socials-list" >
                                <a href="https://www.instagram.com/karmapolitan/" target="_blank"
            ...
            <div className="container" >
                <div className="links" >
                    <div className="links-logo" >
                        ...
                        <div className="links-logo__subtext" >ГОРОДСКАЯ ЛАБОРАТОРИЯ. ВМЕСТЕ РАЗВИВАЕМ ГОРОД!
                        </div>
                    </div>
                    <a href="/about" className="links__item" >О проекте</a><a href="/contacts" lassName="links__item" >Свяжитесь с
                    нами</a><a href="/policy" className="links__item" >Политика конфиденциальности</a>
                    <a href="/rights" className="links__item" >Интеллектуальные
                    права</a>
                </div>
            </div>
        </div>
